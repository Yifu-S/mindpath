...
app.get("/api/strategies", authenticateToken, async (req, res) => {
        ...
        pool1: [
          {
            id: 337,
            category: "social",
            title: "Social Stress Management",
            description: "Handle social situations with less stress",
            steps: [
        ...
        pool1: [
          {
            ...
            description: "Handle relationship stress constructively",
            steps: [
        ...
        pool1: [
          {
            ...
            category: "financial",
            title: "Financial Stress Management",
            description: "Handle financial stress constructively",
            steps: [
        ...
        pool1: [
          {
            ...
            description: "Handle career-related stress",
            steps: [
              "Focus on what you can control",
              "Break career planning into small steps",
              "Practice self-compassion",
        ...
        pool1: [
          {
            id: 377,
            category: "health",
            title: "Health Stress Management",
            description: "Handle health-related stress",
            steps: [
              "Focus on facts, not fears",
              "Practice good self-care",
              "Seek professional help if needed",
              "Build a support network",
              "Celebrate health wins",
            ],
          },
          {
            id: 378,
        ...
        pool1: [
          {
            id: 289,
            category: "social",
            title: "Relationship Confidence Building",
            description: "Build confidence in relationships",
            steps: [
              "Be vulnerable and share your feelings",
              "Show genuine interest in others",
              "Spend quality time together",
        ...
        pool1: [
          {
            id: 305,
            category: "financial",
            title: "Financial Confidence Building",
            description: "Build confidence in financial matters",
            steps: [
              "Track your expenses for one week",
              "Create a simple budget",
              "Set financial goals",
        ...
        pool1: [
          {
            id: 313,
            category: "health",
            title: "Health Confidence Building",
            description: "Build confidence in health matters",
            steps: [
              "Focus on facts, not fears",
              "Practice good self-care",
              "Seek professional help if needed",
        ...
        pool1: [
          {
            ...
            description: "Channel excitement into positive social interactions",
            steps: [
              "Use your energy to connect with others",
              "Share your enthusiasm appropriately",
        ...
        pool1: [
          {
            ...
            description: "Channel excitement into positive relationships",
            steps: [
              "Share your enthusiasm with your partner",
              "Plan exciting activities together",
              "Communicate openly about your feelings",
        ...
        pool1: [
          {
            id: 417,
            category: "financial",
            title: "Financial Energy Management",
            description: "Channel excitement into positive financial planning",
            steps: [
              "Use your energy to research financial opportunities",
              "Create a budget with enthusiasm",
              "Set financial goals",
              "Research student financial resources",
              "Build an emergency fund",
            ],
        ...
        pool1: [
          {
            id: 425,
            category: "health",
            title: "Health Energy Management",
            description: "Channel excitement into positive health habits",
            steps: [
              "Use your energy to exercise regularly",
              "Plan healthy meals with enthusiasm",
              "Practice good self-care",
              "Build a support network",
              "Celebrate health wins",
            ],
        ...
        pool1: [
          {
            id: 433,
            category: "social",
            title: "Social Frustration Management",
            description: "Handle social frustration constructively",
            steps: [
        ...
        pool1: [
          {
            id: 441,
            category: "social",
            title: "Relationship Frustration Management",
            description: "Handle relationship frustration constructively",
            steps: [
              "Take time to cool down first",
        ...
        pool1: [
          {
            id: 457,
            category: "financial",
            title: "Financial Frustration Management",
            description: "Handle financial frustration constructively",
            steps: [
        ...
        pool1: [
          {
            id: 465,
            category: "academic",
            title: "Career Frustration Management",
            description: "Handle career-related frustration",
            steps: [
        ...
        pool1: [
          {
            id: 473,
            category: "health",
            title: "Health Frustration Management",
            description: "Handle health-related frustration",
            steps: [
              "Take a step back and assess the situation",
              "Focus on what you can control",
              "Practice good self-care",
  ...
  db.get(recentMoodQuery, [userId], (err, row) => {
    ...
    try {
      ...
      const context = decryptedContext
        .toLowerCase()
        .trim()
        .replace(/\s+/g, " ")
        .trim();

      // Map context variations to standard keys
      const contextMapping = {
        ...
        family: "family",
        financial: "financial",
        "career/future": "career/future",
        health: "health",
      };

      const normalizedContext = contextMapping[context] || context;
      ...
      let contextPools = emotionPools[normalizedContext];
      if (!contextPools) {
        console.log("❌ No exact match found for context:", normalizedContext);
        ...
        const similarContext = availableContexts.find(
          (available) =>
            available.includes(normalizedContext) ||
            normalizedContext.includes(available)
        );
